...
if __name__ == "__main__":
    ...
    trainSetFileName = "/host/msai/data/TrainData.ctf"
    validationSetFileName = "/host/msai/data/ValidationData.ctf"
    testSetFileName = "/host/msai/data/EvaluationData.ctf"
    submissionFileName = "/host/msai/data/answer.tsv"
